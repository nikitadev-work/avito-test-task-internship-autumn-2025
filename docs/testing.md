...
***Обязательно выполнить запрос на создание команды, чтобы тестер обращался для создания pull request для уже созданных пользователей(например, через Postman через запрос Add Team)***
